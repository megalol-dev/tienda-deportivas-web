...
public class AuthController {
    ...
    public UsuarioRespuesta login(
        ...
        // Creamos un SecurityContext con el usuario autenticado
        ...
        // Guardamos el SecurityContext dentro de la sesión
        session.setAttribute(
                HttpSessionSecurityContextRepository.SPRING_SECURITY_CONTEXT_KEY,
                securityContext);

        // Recuperamos nuestro Usuario para construir la respuesta
